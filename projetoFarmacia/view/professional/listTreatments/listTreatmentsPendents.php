...
<!--============================================= TITULO =============================================-->
            ...
            <div id="tituloCentral">
                ...
                <div class="col-auto" id="titleCPF">
                    ...
                    <h1> <strong>Tratamentos pendentes</strong> </h1>
            ...
            <form>
                ...
                <div class="row g-3" id="mainDiv">                     
                    ...
                    <div class="divRemedy">
                        ...
                        <div class="btn-group" id="treeButtons">

                            <div class="input-group">

                                <div class="row-2">

                                    <a href="listTreatments.php">
                                ...
                                <div class="row-2">
                                    ...
                                    <a href="listTreatmentsPendents.php">
                                        <button type="button" id="todos" class="btn btn-outline-secondary active">
                                            Solicitações
                                        </button>
                                    </a>
                                    ...
                                    <tbody>
                                            ...
                                            <?php
                                                ...
                                                if($systemLevelAccess == 1){
                                                    ...
                                                    include_once('../../../actions/professional/listTreatments/listMyTreatmentsPendents.php');
