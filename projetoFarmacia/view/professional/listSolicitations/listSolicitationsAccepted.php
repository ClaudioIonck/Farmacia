...
<!--============================================= TITULO =============================================-->
            ...
            <div id="tituloCentral">
                ...
                <div class="col-auto" id="titleCPF">
                    ...
                    <h1> <strong>Solicitações aceitas</strong> </h1>
                        ...
                        <div class="input-group">
                            ...
                            <div class="row-2">
                                ...
                                <a href="listSolicitationsAccepted.php">
                                    <button type="button" id="todos" class="btn btn-outline-success active" >
                                        Aceitos
                                    </button>
                                </a>
                            ...
                            <div class="row-2">
                                ...
                                <a href="listSolicitationsRecused.php">
                                    <button type="button" id="todos" class="btn btn-outline-danger" >
                                        Recusados
                                    </button>
                                </a>
                                    ...
                                    <tbody>
                                            ...
                                            <?php
                                                ...
                                                if($systemLevelAccess == 1){
                                                    ...
                                                    include_once('action/listAllRequestAccepted.php');

                                                }else if($systemLevelAccess == 0){

                                                    include_once('action/listMyRequestAccepted.php');
