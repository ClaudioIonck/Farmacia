<?php
    ...
    if(!empty($_GET['idTreatment'])) {
        ...
        $refreshStatusRequestQuery = "UPDATE treatments SET statusTreatment = 3 WHERE idTreatment = $idTreatment"; 
        ...
        $refreshStatusRequestPermissionQuery = "UPDATE treatmentpermissionsrequest SET statusRequest = 3 WHERE idTreatment = $idTreatment"; 
        ...
        $refreshStatusComplementQuery = "UPDATE treatmentpermissionsrequest SET statusComplement = 'Profissional Cancelou' WHERE idTreatment = $idTreatment"; 
