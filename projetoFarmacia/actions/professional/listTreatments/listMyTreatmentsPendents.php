<?php
    ...
    if($loginSuccessful){
        ...
        WHERE idProfessional = $userId AND statusTreatment = 4
        ...
        while($rowInfo = $selectInfoTables->fetch(PDO::FETCH_ASSOC)){
            ...
            if($rowInfo['idProfessional'] == $userId){
                ...
                echo "<tr>";
                    ...
                    <a href='action/cancelRequest.php?idTreatment=$rowInfo[idTreatment]'>
                    ...
                    <a href='action/viewRequest.php?idTreatment=$rowInfo[idTreatment]'>
        ...
        echo "Login Successful is false";
