<?php
    ...
    if(!empty($_GET['idTreatment'])) {
        ...
        $refreshStatusRequestQuery = "UPDATE treatments SET statusTreatment = 0 WHERE idTreatment = $idTreatment"; 
        ...
        $refreshStatusRequestPermissionQuery = "UPDATE treatmentpermissionsrequest SET statusRequest = 0 WHERE idTreatment = $idTreatment"; 
        ...
        $refreshStatusComplementQuery = "UPDATE treatmentpermissionsrequest SET statusComplement = 'Recusado' WHERE idTreatment = $idTreatment"; 
